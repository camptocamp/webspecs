...
<!-- Das Links & Texte müssen je nach Version angepasst werden: Komplett / Erweitert / Einfach -->	
																		<a target="_self">																		
																			<xsl:attribute name="href">
																				<xsl:text>http://tc-geocat0i.bgdi.admin.ch/geonetwork/srv/deu/metadata.formatter.html?xsl=bs_simple_test_110718&amp;uuid=</xsl:text>
																		...
																		<a target="_self">																		
																			<xsl:attribute name="href">
																				<xsl:text>http://tc-geocat0i.bgdi.admin.ch/geonetwork/srv/deu/metadata.formatter.html?xsl=bs_extended_test_110718&amp;uuid=</xsl:text>
																				<xsl:value-of select="gmd:fileIdentifier/gco:CharacterString"/>
																			</xsl:attribute>
																			Erweitert</a>
																	</td>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<ul>
						<xsl:for-each select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:topicCategory">
							<li><xsl:value-of select="gmd:MD_TopicCategoryCode"/></li>
						</xsl:for-each>
					</ul>
				</td>
			</tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<ul>
						<xsl:for-each select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:descriptiveKeywords">
							<li><xsl:value-of select="gmd:MD_Keywords/gmd:keyword/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[@locale='#DE']"/></li>
						</xsl:for-each>
					</ul>
				</td>
			</tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<ul>
						<xsl:for-each select="gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine">
							<li><xsl:value-of select="gmd:CI_OnlineResource/gmd:name/gco:CharacterString"/><xsl:text disable-output-escaping="no">&#160;&#45;&#160;</xsl:text><xsl:value-of select="gmd:CI_OnlineResource/gmd:description/gco:CharacterString"/><br/>
								<a href="{gmd:CI_OnlineResource/gmd:linkage/gmd:URL}" target="_new"><xsl:value-of select="/gmd:CI_OnlineResource/gmd:linkage/gmd:URL"/> <xsl:value-of select="gmd:CI_OnlineResource/gmd:linkage/gmd:URL"/></a></li>
						</xsl:for-each>
					</ul>
				</td>
			</tr>	
