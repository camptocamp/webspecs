...
class AccumulatingRequest12[-In,+T1,+T2,+T3,+T4,+T5,+T6,+T7,+T8,+T9,+T10,+T11,+T12,+Out](
  ...
  override def assertPassed(in: In)(implicit context: ExecutionContext, uriResolvers:UriResolver):AccumulatedResponse12[T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,Out] =
...
def trackThen [A,B] (next: Response[Out] => Request[Out,A]):AccumulatingRequest13[In,T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,Out,A] =
  ...
  def execute(in: In)(implicit context: ExecutionContext, uriResolvers:UriResolver):AccumulatedResponse12[T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,Out] = {
