...
class AccumulatingRequest8[-In,+T1,+T2,+T3,+T4,+T5,+T6,+T7,+T8,+Out](
  ...
  override def assertPassed(in: In)(implicit context: ExecutionContext, uriResolvers:UriResolver):AccumulatedResponse8[T1,T2,T3,T4,T5,T6,T7,T8,Out] =
...
def trackThen [A,B] (next: Response[Out] => Request[Out,A]):AccumulatingRequest9[In,T1,T2,T3,T4,T5,T6,T7,T8,Out,A] =
  ...
  def execute(in: In)(implicit context: ExecutionContext, uriResolvers:UriResolver):AccumulatedResponse8[T1,T2,T3,T4,T5,T6,T7,T8,Out] = {
